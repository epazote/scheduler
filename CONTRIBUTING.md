# Contributing to 🌿 epazote/scheduler

First and foremost, thank you! We appreciate that you want to contribute to
**epazote/scheduler**, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for epazote/scheduler**
...
support for **epazote/scheduler**:

- star :star: the [project](https://github.com/epazote/scheduler)
...
- **version**: please note the version of **epazote/scheduler** are you using
- **extensions, plugins, helpers, etc** (if applicable): please list any extensions you're using
- **error messages**: please paste any error messages into the issue, or a [gist](https://gist.github.com/)

### Closing issues

The original poster or the maintainer's of **epazote/scheduler** may close an issue at
